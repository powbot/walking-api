...
import dax_api.shared.helpers.AccurateMouse;
        ...
        switch (specialLocation){
            ...
            case AL_KHARID_TOLL_E:
                InteractionHelper.click(InteractionHelper.getRSObject(Filters.Objects.nameEquals("Gate"))
                        , "Pay-toll(10gp)",
                        () -> Player.getPosition().equals(AL_KHARID_TOLL_W.getRSTile()) ? WaitFor.Return.SUCCESS : WaitFor.Return.IGNORE);
                break;
            case AL_KHARID_TOLL_W:
                InteractionHelper.click(InteractionHelper.getRSObject(Filters.Objects.nameEquals("Gate"))
                        , "Pay-toll(10gp)",
                        () -> Player.getPosition().equals(AL_KHARID_TOLL_E.getRSTile()) ? WaitFor.Return.SUCCESS : WaitFor.Return.IGNORE);
                break;
