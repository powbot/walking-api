...
public class VarbitHelper {
    ...
    public static boolean hasOpenedLumbridgeCavesShortcut(){
        return RSVarBit.get(538).getValue() > 0;
    }

    public static boolean canUseFairyRings(){
        return RSVarBit.get(2328).getValue() > 0;
    }
...
//            } else {
//                varpsValue = varpsValue & ~(1 << i);
//            }
//        }
//        varpsValue = varpsValue >> startBit;
//        return Math.abs(varpsValue);
